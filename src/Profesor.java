...
public class Profesor {
	...
	public ArrayList<String> getNumeCursuriTitular()
	{
		ArrayList<String> cursuriTitular = new ArrayList<String>();
		for(Curs c: cursuri)
		{
			String cName = c.getNumeCurs();
			cursuriTitular.add(cName);
		}
		return cursuriTitular;
	}
	@Override

...
public class Curs  {
	...
	public String getNumeCurs(){return this.nume;}
	...
	public void AfisareNoteStudentCurs(Student s)
	{
		for(Map.Entry<Student,Integer> entry:nota.entrySet()){
			if(entry.getKey().equals(s))
			{
				System.out.print(Integer.toString(entry.getValue()));
				return;
			}
		}
		System.out.println("Nu exista nota la acest curs pentru  studentul dat!");
	}
	...
	public int getNotaStudent(Student s)
	{
		for(Map.Entry<Student,Integer> mEntry:nota.entrySet())
		{
			if(mEntry.getKey().equals(s))
			{

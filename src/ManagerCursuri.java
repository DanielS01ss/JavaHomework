...
public class ManagerCursuri {
	...
	public ArrayList<Curs> getProfessorCursuri(Profesor prof)
	{
		ArrayList<Curs> cursuriProf = new ArrayList<Curs>();
		for(Curs c:cursuri)
		{
	...
	public Student populateEnrolledCourseStudent(Student s)
	{
		ArrayList<Curs> cursuriStudent = new ArrayList<Curs>();
		for(Curs c:cursuri)
		{
			if(c.hasStudent(s))
			{
				cursuriStudent.add(c);
			}
		}

		s.cursuriInscrisi = cursuriStudent;
		return s;
	}

	public ArrayList<Curs> getAllCourses()
	{
		ArrayList<Curs> c = new ArrayList<Curs>();
		for(Curs cI:cursuri)
		{
			c.add(cI);
		}
